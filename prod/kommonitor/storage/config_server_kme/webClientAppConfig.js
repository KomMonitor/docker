try {
  ...
  window.__env.appTitle = "KomMonitor KME";
  ...
  window.__env.localStoragePrefix = "kommonitor-unique-instanceName-kme";
  ...
  */
  ...
  window.__env.apiUrl = "https://localhost/kommonitor/api/datamanagement/";
  // Base url for Data Management API
  window.__env.basePath = 'management';

  // Processing Engine URL
  window.__env.targetUrlToProcessingEngine = 'https://localhost/kommonitor/api/processingengine/processing/';
  ...
  // Data Importer URL
  window.__env.targetUrlToImporterService = 'https://localhost/kommonitor/api/importer/importer/';
 ...
 // various color settings
  ...
  // classification
  //allowedValues: equal_interval, quantile, jenks
  window.__env.defaultClassifyMethod = "equal_interval";
  window.__env.disableManualClassification = false;

  // array of indicator or georesource name substring that shall be used to filter out / hide certain indicators by their name
